...
Vagrant.configure("2") do |config|
  ...
  config.vm.define "ScrapingMicroserviceJavaPython" do |vapro|
  end
  ...
  config.vm.provider :virtualbox do |vb|
    ...
    vb.name = "ScrapingMicroserviceJavaPython"
  ...
  config.vm.provision "shell", path: "rabbitmq.sh", args: [rabbitmq_user, rabbitmq_password]
